...
const CUSTOM_TEMPLATE_CRITERIA = [
  ...
  "",
  "## 📖 Glosario",
  "[BLOQUE OBLIGATORIO. No omitir. Incluye TODOS los términos técnicos del documento (incluso los de código). Usa la siguiente estructura y agrega tantas filas como términos detectes (pueden ser decenas).]",
  "",
  "| Término | Categoría | Definición |",
  "| --- | --- | --- |",
  "| [Término] | [Concepto \\| Función-Método \\| Sintaxis \\| Acrónimo \\| Patrón \\| Comando \\| Tipo-dato \\| Estructura \\| Propiedad \\| Error \\| Archivo-formato \\| Convención \\| Otro] | [Definición breve (1–2 líneas) basada EXACTAMENTE en cómo se usó el término en este documento. No uses definiciones genéricas de internet.] |",
  "| [Término] | [categoría] | [definición] |",
  "| [Término] | [categoría] | [definición] |",
  "| [... agrega una fila por cada término técnico detectado] | [...] | [...] |",
  "",
  "Reglas del Glosario:",
  "- Repasa TODO el documento (párrafos, títulos, bloques de código, tablas, errores comunes, referencias) y extrae CADA palabra técnica.",
  "- Si un término aparece en varias secciones, inclúyelo UNA SOLA VEZ.",
  "- Si hay dudas sobre si incluir una palabra, inclúyela (mejor que falte).",
  "- No definas conceptos que no aparezcan en el documento.",
  "",
